...
# V2 Soluções build configuration file
...
linkcheck_ignore = [
    ...
    r"https://github.com/lflrocha/v2soluções/issues/new",  # requires auth
...
html_theme_options = {
    ...
    "icon_links": [
        {
            "name": "GitHub",
            "url": "https://github.com/lflrocha/v2soluções",
    ...
    "repository_url": "https://github.com/lflrocha/v2soluções",
...
# html_context = {
#     "edit_page_url_template": "https://github.com/lflrocha/v2soluções/edit/main/docs/",
# }
...
ogp_site_name = "V2 Soluções Documentation"
ogp_type = "website"
...
htmlhelp_basename = "V2 SoluçõesDocumentation"
...
latex_documents = [
    (
        "index",
        "V2 SoluçõesDocumentation.tex",
        "V2 Soluções Documentation",
        "lflrocha community",
        "manual",
    ),
]
